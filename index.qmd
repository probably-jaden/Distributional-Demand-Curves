...
If you wanted to see the R code that I used the repo can be found [here](https://github.com/probably-jaden/Distributional-Demand-Curves/blob/main/index.qmd)
